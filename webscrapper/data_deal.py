...
if __name__ == "__main__":
    # file1 = scrape.scrape("http://quotes.toscrape.com/")
    # value = file1.initiatescrape()

    dummy_html = str(''' <!DOCTYPE html>
<html lang="en">
<head>
        <meta charset="UTF-8">
...
<div class="row">
    ...
    <div class="quote" itemscope itemtype="http://schema.org/CreativeWork">
        <span class="text" itemprop="text">“There are only two ways to live your life. One is as though nothing is a miracle. The other is as though everything isa miracle.”</span>
        <span>by <small class="author" itemprop="author">Albert Einstein</small>
        <a href="/author/Albert-Einstein">(about)</a>
        </span>
        <div class="tags">
    ...
    create_data(data)
    value = filter(dummy_html, {'class_': 'next'})
    print(f"The reulst is {value}")
